...
export default class sidebar extends Component{
    ...
    render(){
        ...
        return (
            <View style={{zIndex:10,backgroundColor:"white" , flex:1}}>
                ...
                <View style={{marginLeft:20,marginTop:70}}>
                    ...
                    <Text style={{color :"white"}}>example_name</Text>
                    <Text style={{fontSize:12 , color :"white", marginBottom:15}}>example_email@gmail.com</Text>
                    <ScrollView  style={{marginLeft:-20   }}>
                        ...
                        <List style={{borderBottomWidth:1 , borderBottomColor: "#aaa" }}>
                            ...
                            <ListItem icon  >
                                ...
                                <Body style={{borderBottomWidth:0}}>
                                    <Text style={{fontWeight:"bold",fontSize:13,color:"#444"}}  onPress={() => {this.props.parent.props.navigation.navigate("mainScreen")}}>Beranda</Text>
                                </Body>
                        ...
                        <List style={{borderBottomWidth:1 , borderBottomColor: "#aaa" }}>
                            ...
                            <ListItem icon onPress={() => {this.props.parent.props.navigation.navigate("screenThree")}} >
                                <Left>
